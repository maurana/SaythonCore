...
/// <summary>
/// Saython SQL Server Executor Class
/// </summary>
namespace Saython.Framework.SQLServerDataAccess
{
    public class SaythonSQLServerExecutor
    {
        ...
        public SaythonSQLServerExecutor(string conString)
        {
